...
| Suite de regresión | `pnpm test` y `tsc --noEmit` | **47 archivos / 186 pruebas aprobadas** y TypeScript sin errores. |
...
| Archivos de perfil y CV | Las URLs de almacenamiento son no adivinables, pero un enlace compartido puede abrir el archivo. | Implementar entrega autorizada con URLs firmadas de corta duración y metadatos privados por usuario. |
