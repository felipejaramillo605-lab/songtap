...
describe("pqrsExport", () => {
  ...
  it("crea un libro con resumen, locales y periodo activo", () => {
    ...
    expect(XLSX.utils.sheet_to_json(workbook.Sheets.Locales)).toEqual([expect.objectContaining({ Local: "Bar, Central", Resueltas: 5, "Cumplimiento SLA": "75%", "Cumplimiento SLA anterior": "50%", "Variación SLA (pp)": "+25 pp", "Tipo PQRS": "Queja", "Estado PQRS": "Resuelta" })]);
  });
